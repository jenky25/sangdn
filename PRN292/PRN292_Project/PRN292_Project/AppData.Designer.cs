...
namespace PRN292_Project {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(int id, string name, bool gender, int did) {
        ...
        public partial class StudentRow : global::System.Data.DataRow {
            ...
            public int did {
                get {
                    return ((int)(this[this.tableStudent.didColumn]));
                }
                set {
...
namespace PRN292_Project.AppDataTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([id] = @Original_id) AND ([name] = @Original_" +
                "name) AND ([gender] = @Original_gender) AND ([did] = @Original_did))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([id], [name], [gender], [did]) VALUES (@id, @name, @" +
                "gender, @did);\r\nSELECT id, name, gender, did FROM Student WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [id] = @id, [name] = @name, [gender] = @gender, [did] = @did WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([gender] = @Original_gender) AND ([did] = @Original_did));
SELECT id, name, gender, did FROM Student WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PRN292_Project.Properties.Settings.Default.PRJ321_FALL_2019_B5ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, gender, did FROM dbo.Student";
        ...
        public virtual int Delete(int Original_id, string Original_name, bool Original_gender, int Original_did) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_did));
        ...
        public virtual int Insert(int id, string name, bool gender, int did) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(did));
        ...
        public virtual int Update(int id, string name, bool gender, int did, int Original_id, string Original_name, bool Original_gender, int Original_did) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, bool gender, int did, int Original_id, string Original_name, bool Original_gender, int Original_did) {
            return this.Update(Original_id, name, gender, did, Original_id, Original_name, Original_gender, Original_did);
        }
    }
